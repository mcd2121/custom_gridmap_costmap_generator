#ifndef CUSTOM_GRIDMAP_COSTMAP_GENERATOR__OBSTACLEFILTER_HPP_
#define CUSTOM_GRIDMAP_COSTMAP_GENERATOR__OBSTACLEFILTER_HPP_
 ...
 */
template<typename T>
class ObstacleFilter : public filters::FilterBase<T>
{
public:
  /*!
   * Constructor
...
#endif  // GRID_MAP_FILTERS__ObstacleFilter_HPP_